...
impl LinkPannel {
    ...
    pub fn ui_ct(&mut self, ui: &mut egui::Ui) {
        let _size = egui::Vec2::new(100.0, 100.0);
        ui.vertical(|ui| match self.mtrace.roaming {
            true => {
                if self.mtrace.roaming == true {
                    ui.colored_label(egui::Color32::RED, "roaming");
                } else {
                    ui.label("roaming");
                }
            }
            false => {
                if self.mtrace.roaming == false {
                    ui.colored_label(egui::Color32::BLACK, "roaming");
                } else {
                    ui.label("roaming");
                }
            }
